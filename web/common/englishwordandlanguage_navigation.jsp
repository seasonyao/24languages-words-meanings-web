        ...
        <TABLE cellSpacing=0 cellPadding=0 width=200px border=0>
            ...
            <TR>
                <TD width=165 height="29" bgColor=#666699>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <A class=nav href="addEnglishWordForm" style="color: #000000">新增英语单词</A>
                </TD>
            </TR>
            <TR>
                <TD bgColor=#ffffff colSpan=2>
            ...
            <TR>
                <TD width=165 height="29" bgColor=#666699>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <A class=nav href="addLanguageForm" style="color: #000000">新增语言种类</A>
                </TD>
            </TR>
            <TR>
                <TD bgColor=#ffffff colSpan=2>
            ...
            <TR>
                <TD width=165 height="29" bgColor=#666699>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <A class=nav href="listEnglishWords" style="color: #000000">查看英语单词信息</A>
                </TD>
            </TR>
            <TR>
                <TD bgColor=#ffffff colSpan=2>
            ...
            <TR>
                <TD width=165 height="29" bgColor=#666699>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <A class=nav href="listLanguages" style="color: #000000">查看语言种类信息</A>
                </TD>
            </TR>
            <TR>
                <TD bgColor=#ffffff colSpan=2>
