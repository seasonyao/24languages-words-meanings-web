...
public class ListWordMeaningsServlet extends HttpServlet {
    private static final String LIST_WORDMEANINGS = "listWordMeaning.jsp";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        wordMeaningList = wordMeaningService.getAllWordMeaning();
        session.setAttribute("wordMeaningList",wordMeaningList);

        request.getRequestDispatcher(LIST_WORDMEANINGS).forward(request,response);
    }
}
