...
public class FindWordMeaningsByMeaningNameServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String meaningName=request.getParameter("meaningName");
        HttpSession session = request.getSession();
        wordMeaningList = wordMeaningService.getWordMeaningByMeaningName(meaningName);
